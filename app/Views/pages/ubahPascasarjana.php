        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php endif; ?> <?php if ($validation->hasError('tahunAngkatan')) : ?>
                    <div class="alert alert-danger" role="alert">
                        <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                        <strong>Failed ! </strong><?= $validation->getError('tahunPascasarjana'); ?>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <form autocomplete="off" class="form-horizontal" action="/ubahPascasarjana" method="POST">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control select" name="tahunPascasarjana">
                                    <option value="">-- Select --</option>
                        ...
                        <?php if ($termYear != null && $entryYear != null && $paymentOrder != null && $startDate != null && $endDate != null) : ?>
                            <form action="/ubahPascasarjana/cetak" method="post">
                                <input class="hidden" name="tahunAjar" value="<?= $termYear; ?>">
                                <input class="hidden" name="tahunPascasarjana" value="<?= $entryYear; ?>">
